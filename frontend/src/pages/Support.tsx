  ...
  return (
    <main className="bg-[#0B1020]">
      <PageHero
        eyebrow="Help center"
        title="Support"
        description="Your issues haven't been heard? Directly contact management for issues related to payments, winnings, staff queries, feedback and more."
      />
      ...
      <section className="px-4 py-14 sm:px-6 sm:py-20">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 min-h-12 w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-base text-white outline-none focus:border-[#FFD54A]/50"
                    required
                    minLength={3}
                    maxLength={200}
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="mt-1 w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-base text-white outline-none focus:border-[#FFD54A]/50"
                    required
                    minLength={10}
                    maxLength={16000}
                  />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-glow touch-manipulation rounded-xl bg-[#FFD54A] px-6 py-3 text-base font-bold text-neutral-950 transition disabled:opacity-50"
                >
              ...
              <ul className="mt-4 space-y-3 text-sm">
                {mine.map((t) => (
                  ...
                  >
                    ...
                    <span className="text-xs text-[#FFD54A]">
                      {t.status}
        ...
        <p className="mx-auto mt-12 max-w-3xl text-center text-sm text-neutral-500">
          ...
          <Link
            to="/"
            className="font-medium text-[#FFD54A] underline-offset-4 hover:underline"
          >
            Back to home
          </Link>
        </p>
