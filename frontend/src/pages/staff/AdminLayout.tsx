...
type NavItem = { to: string; end?: boolean; label: string; Icon: typeof Users }
    ...
    <div className="flex h-dvh max-h-dvh min-h-0 overflow-hidden bg-gray-50">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <main className="flex min-h-0 flex-1 flex-col overflow-hidden">
          <div className="mx-auto flex min-h-0 w-full max-w-7xl flex-1 flex-col overflow-y-auto p-4 sm:p-6">
            <Outlet />
          </div>
        </main>
      </div>
