                ...
                <li key={p._id}>
                  <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.07] to-transparent transition hover:-translate-y-0.5 hover:border-[#FFD54A]/35 hover:shadow-[0_24px_60px_rgba(0,0,0,0.35)]">
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      <span className="inline-flex w-fit rounded-lg bg-[#FFD54A]/15 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-[#FFD54A]">
                        Partner
                      </span>
                      ...
                      {p.gameLink?.trim() ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="mt-6 block w-full rounded-xl border border-white/15 py-2.5 text-center text-sm font-semibold text-white transition hover:border-[#FFD54A]/50 hover:text-[#FFD54A]"
                        >
                          Open platform
                        </a>
                      ) : (
